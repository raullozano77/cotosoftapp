...
@Component({
  selector: 'form_eventosComponent',
  templateUrl: './form_eventos.component.html',
  styleUrls: ['./../../../assets/css/secciones.css']
}

) export class FormDatosEventosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.titulo = 'Pagina FormDatosEventosComponent';
  }
